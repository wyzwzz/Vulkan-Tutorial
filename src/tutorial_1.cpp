...
class HelloTriangleApplication
{
  ...
  private:
    ...
    bool checkValidationLayerSupport(){
        ...
        std::cout<<"available validation layer:\n";
    ...
    std::vector<const char*> getRequiredExtensions(){
        ...
        for(int i = 0;i<glfwExtensionCount;i++)
            std::cout<<"glfwExtensions: "<<*(glfwExtensions+i)<<std::endl;
...
//                  <<"\n\tname: "<<deviceProperties.deviceName<<std::endl;
...
//        deviceFeatures.geometryShader;
    ...
    SwapChainSupportDetails querySwapChainSupport(VkPhysicalDevice device){
        ...
        std::cout<<"physical device surface format count "<<formatCount<<std::endl;
        ...
        std::cout<<"physical device surface present mode count "<<presentModeCount<<std::endl;
    ...
    void createGraphicsPipeline(){
        auto vertShaderCode = readFile(assetPath+"shaders/tutorial_1/shader.vert.spv");
        auto fragShaderCode = readFile(assetPath+"shaders/tutorial_1/shader.frag.spv");
     ...
     * 4.add a comnined image sampler descriptor to sample color from the texture
     */
